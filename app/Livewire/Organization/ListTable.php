...
class ListTable extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.organization.list-table', compact('organizations'));
    }
    ...
    public function delete($organizationId): void
    {
        ...
        if (! auth()->user()->can('delete', $organization)) {
            $this->dispatch('show-error-toast', [
                'message' => __('messages.organization_delete_unauthorized')
            ]);
     ...
     * 조직 편집 모달 열기
     */
    public function editOrganization($organizationId): void
    {
        // TODO: 권한 체크

        $this->dispatch('open-edit-organization', organizationId: $organizationId);
    }
