...
return [
    ...
    'category' => [
        'name' => [
            ...
            'string' => '카테고리 이름은 문자열이어야 합니다.',
            'max' => '카테고리 이름은 255자를 초과할 수 없습니다.',
        ],
        'description' => [
            'string' => '설명은 문자열이어야 합니다.',
            'max' => '설명은 1000자를 초과할 수 없습니다.',
        ],
        'parent_id' => [
            'exists' => '유효하지 않은 상위 카테고리입니다.',
        ],
        'sort_order' => [
    ...
    'device_model' => [
        'name' => [
            ...
            'max' => '모델명은 255자 이하로 입력해주세요.',
        ],
        'manufacturer' => [
            'max' => '제조사명은 255자 이하로 입력해주세요.',
        ],
    ],
];
