<flux:modal name="add-team-member-modal" class="w-1/2" @close="closeAddTeamMemberModal()">
    <div class="pb-6">
        <flux:heading size="lg" class="mb-4">팀에 사용자 추가</flux:heading>
        <div class="space-y-4">
            <flux:field>
            ...
            <div class="bg-green-900/20 border border-green-800 rounded-lg p-4">
                <flux:heading size="sm" class="text-green-200 mb-2">
                    {{ __('사용자를 찾았습니다') }}
                </flux:heading>
            ...
            <div class="flex justify-end gap-2 mt-6">
                <flux:button wire:click="addMemberToTeam" variant="primary">
                    {{ __('팀에 추가') }}
                </flux:button>
            </div>
            @endif
