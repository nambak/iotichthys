...
<flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
    ...
    <flux:navlist>
        <flux:navlist.group :heading="__('sidebar.user_manage')" class="grid">
            <flux:navlist.item href="{{ route('organization.index') }}">{{__('sidebar.organization_manage')}}
            </flux:navlist.item>
            ...
            <flux:navlist.item href="{{ route('permissions.index') }}">{{__('sidebar.permission_manage')}}
            </flux:navlist.item>
        </flux:navlist.group>
