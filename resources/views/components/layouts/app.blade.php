<x-layouts.app.sidebar :title="$title ?? null">
    <div id="toast-danger"
         class="hidden z-1 fixed top-4 right-4 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
         role="alert">
