...
<head>
    ...
    <style>
        ...
        @layer theme{:root,:host{
            --font-sans:'Noto Sans KR',system-ui,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji";
        ...
        .bubble3 { width: 25px; height: 25px; left: 70%; animation-delay: 2s; }
        .bubble4 { width: 12px; height: 12px; left: 80%; animation-delay: 3s; }
        .bubble5 { width: 18px; height: 18px; left: 90%; animation-delay: 0.5s; }
        ...
        .seaweed1 { left: 5%; animation-delay: 0s; }
        .seaweed2 { right: 8%; height: 120px; animation-delay: 1.5s; }
        ...
        .error-title {
            ...
            font-weight: 900;
            margin: 0;
            background: linear-gradient(45deg, #00BFFF, #FF6B00);
...
<div class="container bg-background flex min-h-svh flex-col items-center justify-center gap-6 p-6">
    ...
    <div class="flex flex-col items-center justify-center gap-6">
        ...
        <p class="text-white" style="font-size: 40px;">접근이 제한된 영역입니다</p>
